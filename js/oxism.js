...
(function() {
  var abs, activeContent, capitalize, colorN, colors, computePositions, debouncer, h, isTouchScreen, key, lastY, navHash, onMove, positions, sqrt, squares, testEl, val, vendor, w;
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    setInterval(function() {
      ...
      return document.documentElement.className = 'color' + colorN;
    }, 8000);
    if (!isTouchScreen) {
