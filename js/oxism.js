...
(function() {
  var abs, activeContent, capitalize, colorN, colors, computePositions, dampen, debouncer, h, isTouchScreen, key, lastY, navHash, onMove, positions, sqrt, squares, testEl, val, vendor, w;
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout((function() {
      return document.documentElement.className = touchClass;
    }), 0);
    navHash();
